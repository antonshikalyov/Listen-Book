...
public final class SidbarMenuBinding implements ViewBinding {
  @NonNull
  ...
  private SidbarMenuBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout sidebarBookmarks,
      @NonNull LinearLayout sidebarHistory, @NonNull LinearLayout sidebarLibrary,
      @NonNull LinearLayout sidebarPlayer, @NonNull LinearLayout sidebarSettings,
      @NonNull LinearLayout sidebarStatistics) {
  ...
  @NonNull
  public static SidbarMenuBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SidbarMenuBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.sidbar_menu, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SidbarMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SidbarMenuBinding((LinearLayout) rootView, sidebarBookmarks, sidebarHistory,
          sidebarLibrary, sidebarPlayer, sidebarSettings, sidebarStatistics);
    }
