...
public final class ActivitySettingsBinding implements ViewBinding {
  ...
  private ActivitySettingsBinding(@NonNull ConstraintLayout rootView, @NonNull Button themeButton) {
  ...
  public static ActivitySettingsBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.theme_button;
      Button themeButton = ViewBindings.findChildViewById(rootView, id);
      if (themeButton == null) {
        break missingId;
      }

      return new ActivitySettingsBinding((ConstraintLayout) rootView, themeButton);
    }
