...
public final class ToolbarSettingsBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageButton backSettingsButton;

  @NonNull
  public final TextView textView;

  private ToolbarSettingsBinding(@NonNull Toolbar rootView, @NonNull ImageButton backSettingsButton,
      @NonNull TextView textView) {
    this.rootView = rootView;
    this.backSettingsButton = backSettingsButton;
  ...
  public static ToolbarSettingsBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.back_settings_button;
      ImageButton backSettingsButton = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ToolbarSettingsBinding((Toolbar) rootView, backSettingsButton, textView);
    }
